...
K = [
 (2, "Keramahtamahan dan sopan santun adalah corak khas yang membedakan bangsa Indonesia dari bangsa lain, yaitu Pancasila sebagai kepribadian bangsa (kisi-kisi BKN hal. 32). Dasar negara berkaitan dengan pengaturan penyelenggaraan negara; pandangan hidup berkaitan dengan pedoman hidup sehari-hari."),
 (1, "Fondasi untuk mengatur penyelenggaraan ketatanegaraan/tata pemerintahan adalah rumusan Pancasila sebagai dasar negara (kisi-kisi BKN hal. 30)."),
 ...
 (0, "Hari Lahir Pancasila 1 Juni (Keppres 24/2016; pidato Soekarno 1 Juni 1945, kisi-kisi BKN hal. 21). 18 Agustus pengesahan UUD, 1 Oktober Hari Kesaktian Pancasila, 28 Oktober Sumpah Pemuda."),
 (3, "Kisi-kisi BKN hal. 23: perisai melambangkan perjuangan, pertahanan, dan perlindungan diri; 'perdamaian' bukan makna perisai."),
 (2, "Padi dan kapas (sila kelima) melambangkan kemakmuran dan kesejahteraan (pangan dan sandang) bagi seluruh rakyat."),
 (0, "Kerakyatan yang dipimpin hikmat kebijaksanaan dalam permusyawaratan/perwakilan = kedaulatan rakyat = demokrasi (kisi-kisi BKN hal. 39)."),
 ...
 (3, "Bab IV Dewan Pertimbangan Agung dihapus pada perubahan keempat UUD 1945 (kisi-kisi BKN hal. 45). MK dan HAM justru ditambahkan; kekuasaan kehakiman tetap ada (Bab IX)."),
 (0, "Pasal 3 ayat (2): MPR melantik Presiden dan/atau Wakil Presiden (kisi-kisi BKN hal. 49)."),
 (2, "Pasal 27 ayat (3): setiap warga negara berhak dan wajib ikut serta dalam upaya pembelaan negara."),
 (3, "Pokok pikiran kedaulatan rakyat/kerakyatan dalam Pembukaan UUD 1945 diwujudkan dengan mengutamakan musyawarah untuk mufakat dalam menyelesaikan masalah (butir sila ke-4, kisi-kisi BKN hal. 38)."),
 (1, "Pasal 1 ayat (1): Negara Indonesia ialah negara kesatuan yang berbentuk republik (kisi-kisi BKN hal. 47)."),
 ...
 (3, "Bentuk baku: apotek, resep, diubah, teori, nasihat (kisi-kisi BKN hal. 85 dan KBBI). Catatan: pada Google Form resminya, opsi A dan B memang tertulis sama persis (cacat soal asli), dipertahankan apa adanya agar sesuai sumber."),
 ...
 (1, "Nama hari berhuruf kapital (Senin); 'upacara bendera' adalah kata umum sehingga huruf kecil (kisi-kisi BKN hal. 74)."),
 (3, "Kata khusus bermakna sempit: mawar (jenis bunga). Buah, pohon, dan tumbuhan adalah kata umum (kisi-kisi BKN hal. 84)."),
 ...
 (1, "UU 25/2004: RPJP Nasional berjangka 20 tahun; RPJMN 5 tahun; RKP 1 tahun (kisi-kisi BKN hal. 93). 'Rencana Pembangunan Jangka Pendek Nasional' tidak ada dalam SPPN."),
 ...
 (1, "Cuti melahirkan untuk kelahiran anak pertama sampai ketiga; anak keempat dan seterusnya memakai cuti besar (kisi-kisi BKN hal. 115)."),
 ...
 (1, "Rumusan 'pengelolaan PNS untuk menghasilkan PNS yang profesional, memiliki nilai dasar, etika profesi, bebas dari intervensi politik, bersih dari KKN' adalah definisi manajemen PNS (kisi-kisi BKN hal. 112). Sistem merit adalah dasar penyelenggaraannya."),
 (3, "Cuti besar diberikan kepada PNS yang telah bekerja paling singkat 5 tahun secara terus-menerus, lamanya paling lama 3 bulan (kisi-kisi BKN hal. 115)."),
 ...
 (3, "Anggota biasa KORPRI: PNS (termasuk camat), pegawai BUMN (Pertamina), BUMD, LPP, BLU/BLUD, Badan Otorita KEK, aparatur desa (kisi-kisi BKN hal. 121). Pegawai RS Siloam (swasta) bukan anggota."),
 (2, "Masa jabatan Dewan Pengurus KORPRI adalah 5 tahun (kisi-kisi BKN hal. 121)."),
 (1, "KORPRI netral dan tidak boleh menerima dana bantuan dari partai politik. Pernyataan lain benar: Panca Prasetya KORPRI (kisi-kisi BKN hal. 120), Dewan Pengurus Nasional di ibu kota negara (hal. 118), anggota luar biasa = pensiunan (hal. 121)."),
 (3, "HUT KORPRI 29 November (dibentuk 29 November 1971 berdasarkan Keppres 82/1971)."),
 (2, "Kisi-kisi BKN hal. 117: pohon pada lambang KORPRI melambangkan kehidupan masyarakat, pengayom dan pelindung bangsa; 17 ranting, 8 dahan, dan 45 daunnya melambangkan perjuangan sesuai fungsi dan peran KORPRI sejak Proklamasi 17 Agustus 1945. Bangunan (balairung lima tiang) = tempat pemersatu anggota dan perekat bangsa; sayap (4 bulu di tengah, 5 di tepi) = pengabdian dan perjuangan; warna emas = keluhuran dan keagungan cita-cita kemerdekaan."),
 (3, "Naskah dinas arahan: pengaturan (peraturan, pedoman, juklak, SOP, surat edaran), penetapan (keputusan), penugasan (instruksi, surat perintah, surat tugas). Surat undangan termasuk naskah dinas korespondensi (kisi-kisi BKN hal. 132)."),
 ...
 (3, "Naskah dinas penetapan berupa keputusan (kisi-kisi BKN hal. 132). Pedoman dan peraturan = pengaturan; instruksi = penugasan."),
 ...
 (2, "Definisi tersebut adalah administrasi menurut Hendi Haryadi dan A. Sugiarto (2009), dikutip kisi-kisi BKN hal. 135."),
 (3, "Kegiatan administrasi meliputi mencatat, mengirim, mengolah, menyimpan, dan mengevaluasi data (kisi-kisi BKN hal. 136); 'prosedur' adalah tata cara, bukan kegiatan administrasi."),
]
